...
<head>
	...
	<title>Daniel Mondzielewski - O mnie</title>
...
<body>
	<nav id="nav">
		...
		<a href="index.php#projects"><div class="nav-element" status="unactive"><i class="icon-code-1"></i> <span class="nav-text">Projekty</span></div></a>
		<a href="index.php#contact"><div class="nav-element" status="unactive"><i class="icon-mail-alt"></i> <span class="nav-text">Kontakt</span></div></a>
		<a href="" onclick="return false;"><div class="nav-element" status="active"><i class="icon-user"></i> <span class="nav-text">O mnie</span></div></a>
	</nav>
