...
<head>
	...
	<title>Daniel Mondzielewski - Over mij</title>
...
<body>
	<nav id="nav">
		...
		<a href="index.php#projects"><div class="nav-element" status="unactive"><i class="icon-code-1"></i> <span class="nav-text">Projecten</span></div></a>
		...
		<a href="" onclick="return false;"><div class="nav-element" status="active"><i class="icon-user"></i> <span class="nav-text">Over mij</span></div></a>
	</nav>
